                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="product-details.html">
                                            <figure>
                                                <img src="<?= base_url()?>public/assets/images/shop/19-1.jpg" alt="product" width="300" height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i class="fas fa-times"></i></button>
                                    </div>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="product-details.html">
                                            <figure>
                                                <img src="<?= base_url()?>public/assets/images/shop/20.jpg" alt="product" width="300" height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i class="fas fa-times"></i></button>
                                    </div>
